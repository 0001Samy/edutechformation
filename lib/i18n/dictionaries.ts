...
export const dictionaries: Record<Locale, Translations> = {
  fr: {
    ...
    home: {
      ...
      approachSubtitle:
        'Notre méthode allie expertise humaine et outils modernes pour faire grandir vos compétences durablement.',
  ...
  en: {
    ...
    home: {
      ...
      approachSubtitle:
        'Our method combines human expertise and modern tools to grow your skills sustainably.',
