...
export const dictionaries: Record<Locale, Translations> = {
  ...
  en: {
    ...
    home: {
      heroBadge: 'Certifying training 2025',
      heroTitle1: 'Transform your',
      heroTitleAccent: 'career',
      heroTitle2: 'with our courses',
      heroSubtitle:
        'Join over 10,000 professionals who have boosted their careers with our expert training.',
      ctaDiscover: 'Discover our courses',
      ...
      feature1Desc:
        'Structured, in-depth courses to fully master each topic, with hands-on projects.',
      feature2Title: 'Expert trainers',
      feature2Desc:
        'Learn from passionate professionals with years of field experience.',
      feature3Title: 'Recognized certification',
      feature3Desc:
        'Earn certifications valued by companies to boost your career.',
      finalCtaBadge: 'Get started now',
      finalCtaTitle: 'Ready to transform your career?',
      finalCtaSubtitle:
        'Join thousands of professionals who have given their journey a new boost.',
      finalCtaButton: 'View courses',
    ...
    about: {
      ...
      heroSubtitle:
        'A Qualiopi-certified organization committed to practical, high-quality professional training.',
      missionTitle: 'Our mission',
      missionText1:
        'Edutech Formations supports professionals in developing their skills through in-person training that is hands-on and directly applicable in the workplace.',
      missionText2:
        'We believe that professional training should be accessible, demanding, and results-oriented. Each program is designed to meet real needs, with clear and measurable learning objectives.',
      valuesTitle: 'Our values',
      valuesSubtitle: 'What guides our daily approach',
      qualityTitle: 'Quality',
      qualityText:
        'Our Qualiopi certification reflects our commitment to a rigorous and transparent training process.',
      proximityTitle: 'Closeness',
      proximityText:
        'Small group sizes and personalized support before, during, and after training.',
      impactTitle: 'Impact',
      impactText:
        'We measure the effectiveness of every training course through skills assessments and satisfaction surveys.',
      qualiopiTitle: 'Qualiopi certification',
      qualiopiText:
        'Edutech Formations has been Qualiopi-certified since 2024 in the "Training actions" category. This national certification attests to the quality of our process and lets you benefit from public or pooled funding (OPCO, France Travail).',
      qualiopiLink: 'Learn more about Qualiopi',
      legalTitle: 'Legal information',
      legalText:
        'Edutech Formations is a SAS with €1,000 share capital, registered under SIREN 977 619 089. Headquarters: 52 rue Montesquieu, 92600 Asnières-sur-Seine, France. Activity: Continuing adult education (NAF 85.59A).',
      finalCtaBadge: "Let's talk",
      finalCtaTitle: 'Want to know more?',
      finalCtaSubtitle: 'Contact us to discuss your training needs.',
    },

    formations: {
      heroTitle: 'Our Courses',
      heroSubtitle: 'Choose the perfect course and develop your skills.',
      filterAriaLabel: 'Filter by category',
      filterAll: 'All',
      filterDroit: 'Law',
      filterMediation: 'Mediation',
      filterIA: 'AI',
      noFormation: 'No course in this category yet.',
      ...
      labelPrice: 'Price',
      formatInter: 'In-person or remote',
      formatIntra: 'On-site or remote',
      formatSurMesure: 'Tailored to your organization',
      durationSurMesure: 'Custom',
      priceSurMesure: 'On request',
      perStudent: 'excl. tax / participant',
      perGroup: 'excl. tax / group',
    ...
    formationDetail: {
      ...
      sectionObjectives: 'Course objectives and skills covered',
      sectionContent: 'Course content',
      sectionProgram: 'Course program',
      sectionEvaluation: 'Evaluation methods',
      sectionFollow: 'Execution follow-up',
      sectionResults: 'Results assessment',
      sectionPedagogicalMeans: 'Pedagogical means and supervision',
      sectionTrainerProfile: 'Trainer profile',
      sectionAccessConditions: 'Access conditions and timeline',
      ...
      ctaReadySubtitle: 'Sign up now and begin your learning journey.',
      ctaReadyButton: 'Contact us',
    ...
    contact: {
      ...
      heroSubtitle:
        'A question? Need information? Our team is here to support you.',
      ...
      subjectFinancing: 'Financing question',
    ...
    testimonials: {
      ...
      heroSubtitle:
        'Discover what our students think of our courses and how they have transformed their careers.',
      ratingValue: '4.8/5 from over 5,000 reviews',
      ratingSubtitle: 'Our students’ satisfaction is our top priority',
      finalCtaTitle: 'Join our satisfied students',
      finalCtaSubtitle:
        'Start your training today and transform your professional future.',
    ...
    accessibility: {
      ...
      heroSubtitle: 'Our commitment to welcoming all learners.',
      commitTitle: 'Our commitment',
      commitText:
        'Edutech Formations is committed to promoting access to professional training for all, including people with disabilities. We adapt our pedagogical methods as much as possible to meet the specific needs of each learner.',
      referentTitle: 'Your disability advisor',
      referentIntro:
        'A disability advisor is available to assess your needs and put the necessary adaptations in place:',
      referentName: 'Olivier Gil',
      referentRole: 'Disability advisor',
      adaptationsTitle: 'Possible adaptations',
      partnersTitle: 'Partners and resources',
      partnersIntro:
        'We work with disability stakeholders to guide you in the best way:',
      anticipateTitle: 'Anticipate your needs',
      anticipateText:
        'So that we can provide the best welcoming conditions, we invite you to inform us of your situation as early as possible, ideally upon first contact or registration.',
      ctaBadge: 'Accessibility',
      ctaTitle: 'Do you have a specific need?',
      ctaSubtitle:
        'Contact our disability advisor to study the possible adaptations together.',
      ctaButton: 'Contact the advisor',
    },
  },
};
