...
export const dictionaries: Record<Locale, Translations> = {
  fr: {
    ...
    home: {
      ...
      approachTitle: 'La formation au service de votre performance',
      approachSubtitle:
        "Dans un monde en constante évolution, les compétences sont votre meilleur levier de réussite.",
      approachPillar1: 'Développement des compétences',
      approachPillar2: 'Accompagnement humain',
      approachPillar3: 'Innovation et IA',
      approachPillar4: 'Résultats concrets',
      featuresTitle: 'Pourquoi choisir Edutech Formations ?',
      featuresSubtitle: 'Nous ne proposons pas des formations standardisées, mais des solutions adaptées à vos enjeux réels.',
      feature1Title: 'Un accompagnement sur mesure de A à Z',
      feature1Desc:
        "Vous avez un besoin spécifique ? Nous concevons des formations sur mesure et adaptées à votre activité.",
      feature2Title: 'Des formations concrètes et opérationnelles',
      feature2Desc:
        "Apprentissage par la pratique, formateurs experts issus du terrain, contenus actualisés en permanence.",
      feature3Title: 'Flexibilité et expertise reconnue',
      feature3Desc:
        "Présentiel sur site ou distanciel en visioconférence. Une approche humaine et engagée, certifiée Qualiopi.",
      finalCtaBadge: 'Démarrez maintenant',
      finalCtaTitle: 'Parlons de votre projet de formation',
      finalCtaSubtitle:
        "Vous avez un besoin spécifique ? Nous vous accompagnons dans la construction de votre solution de formation.",
      finalCtaButton: 'Découvrir nos formations',
      finalCtaContact: 'Demander un devis personnalisé',
    ...
    formations: {
      ...
      statSatisfactionValue: "—",
      statRecommandation: "Taux de recommandation",
      statRecommandationValue: "—",
  ...
  en: {
    ...
    home: {
      ...
      approachTitle: 'Training that drives performance',
      approachSubtitle:
        "In a constantly evolving world, skills are your greatest lever for success.",
      approachPillar1: 'Skill development',
      approachPillar2: 'Human guidance',
      approachPillar3: 'Innovation and AI',
      approachPillar4: 'Tangible results',
      featuresTitle: 'Why choose Edutech Formations?',
      featuresSubtitle: 'We do not offer standardised training, but solutions tailored to your real needs.',
      feature1Title: 'End-to-end bespoke support',
      feature1Desc:
        'Have a specific need? We design training programmes tailored to your activity.',
      feature2Title: 'Concrete, operational training',
      feature2Desc:
        'Learning by doing, expert trainers from the field, constantly updated content.',
      feature3Title: 'Flexibility and recognised expertise',
      feature3Desc:
        'On-site or remote. A human, committed approach, Qualiopi-certified.',
      finalCtaBadge: 'Get started today',
      finalCtaTitle: "Let's talk about your training project",
      finalCtaSubtitle:
        'Do you have a specific need? We support you in building your training solution.',
      finalCtaButton: 'Browse our courses',
      finalCtaContact: 'Request a personalised quote',
