...
export default function Home() {
  ...
  return (
    <div className='bg-gradient-to-b from-gray-50 to-white'>
      {/* Hero Section */}
      <section className='relative bg-gradient-to-br from-primary via-blue-600 to-blue-800 text-white py-32 overflow-hidden'>
        {/* Decorative elements */}
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10'>
          <div ref={heroRef} className='text-center max-w-4xl mx-auto'>
            ...
            <div className='flex flex-col sm:flex-row gap-4 justify-center'>
              <Link
                href='/cours'
                className='inline-flex items-center justify-center gap-2 bg-accent text-gray-900 px-8 py-4 rounded-full font-semibold hover:bg-yellow-300 transition-all hover:scale-105 shadow-lg hover:shadow-xl'
              >
        ...
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
          ...
          >
            <div className='feature-card group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2'>
              <div className='inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-primary to-blue-600 rounded-2xl mb-6 group-hover:scale-110 transition-transform'>
