          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-12'>
            ...
            <div className='bg-white rounded-2xl shadow-xl p-8 md:p-10'>
              ...
              <form onSubmit={handleSubmit} className='space-y-6'>
                ...
                <button
                  type='submit'
                  className='w-full bg-gradient-to-r from-primary to-blue-600 text-white px-6 py-4 rounded-xl font-semibold hover:shadow-lg transition-all hover:scale-[1.02] flex items-center justify-center gap-2'
                >
                  Envoyer le message
                  <Send size={20} />
                </button>
            ...
            <div>
              <div className='bg-white rounded-2xl shadow-xl p-8 md:p-10 mb-8'>
                ...
                <div className='space-y-6'>
                  <div className='flex items-start gap-4 group'>
                    <div className='w-14 h-14 bg-gradient-to-br from-primary to-blue-600 rounded-xl flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform shadow-md'>
              ...
              <div className='bg-gradient-to-br from-primary to-blue-700 text-white rounded-2xl p-8 shadow-xl'>
