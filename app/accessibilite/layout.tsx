...
export const metadata: Metadata = {
  ...
  description:
    "Edutech Formations s'engage à rendre ses formations accessibles à tous, y compris aux personnes en situation de handicap. Référent handicap : Olivier Gil.",
  alternates: { canonical: '/accessibilite' },
  openGraph: {
    title: 'Accessibilité et Handicap | Edutech Formations',
    description:
